...
class _ChatRoomPageState extends State<ChatRoomPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'COLLEGE OF ENGINEERING AND TECHNOLOGY FORUM',
  ...
  String getBotResponse(String message) {
    ...
    if (lowercaseMessage.contains('hello') || lowercaseMessage.contains('hi')) {
      ...
      return 'I\'m just here to assist you!';
      ...
      return 'We offer a wide range of courses, including Information Technology, Computer Science, Computer Engineering, Electrical Engineering, and more. Is there a specific course you\'re interested in?';
